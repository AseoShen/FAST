...
//------------------------Parameter----------------------
`define TV_IN_threshold "../tv/cdatafile/c.fast_accel.autotvin_threshold.dat"
`define TV_IN_rows "../tv/cdatafile/c.fast_accel.autotvin_rows.dat"
`define TV_IN_cols "../tv/cdatafile/c.fast_accel.autotvin_cols.dat"
...
parameter fast_accel_continue_addr = 0;
parameter fast_accel_auto_start_addr = 0;
parameter threshold_data_in_addr = 16;
parameter rows_data_in_addr = 24;
parameter cols_data_in_addr = 32;
...
assign TRAN_CTRL_write_data_finish = 1 & threshold_write_data_finish & rows_write_data_finish & cols_write_data_finish;
